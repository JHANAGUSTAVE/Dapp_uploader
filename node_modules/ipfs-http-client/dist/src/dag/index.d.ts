declare function _exports(codecs: import('ipfs-core-utils/src/multicodecs'), config: import('../types').Options): {
    ...
    import: (source: AsyncIterable<AsyncIterable<Uint8Array>> | Iterable<AsyncIterable<Uint8Array>>, options?: (import("ipfs-core-types/src/dag").ImportOptions & import("../types").HTTPClientExtraOptions) | undefined) => AsyncIterable<import("ipfs-core-types/src/dag").ImportResult>;
    ...
    resolve: (ipfsPath: any, options?: (import("ipfs-core-types/src/dag").ResolveOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<import("ipfs-core-types/src/dag").ResolveResult>;
};
export = _exports;
