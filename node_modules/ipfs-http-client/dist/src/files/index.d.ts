declare function _exports(config: import('../types').Options): {
    ...
    cp: (sources: any, destination: string, options?: (import("ipfs-core-types/src/files").CpOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<void>;
    flush: (path: string, options?: (import("ipfs-core-types").AbortOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<import("multiformats").CID>;
    ls: (path: any, options?: (import("ipfs-core-types").AbortOptions & import("../types").HTTPClientExtraOptions) | undefined) => AsyncIterable<import("ipfs-core-types/src/files").MFSEntry>;
    ...
    read: (path: any, options?: (import("ipfs-core-types/src/files").ReadOptions & import("../types").HTTPClientExtraOptions) | undefined) => AsyncIterable<Uint8Array>;
    ...
    stat: (path: any, options?: (import("ipfs-core-types/src/files").StatOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<import("ipfs-core-types/src/files").StatResult>;
