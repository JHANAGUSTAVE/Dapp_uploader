...
declare class Remote {
    ...
    add(cid: any, options: import("ipfs-core-types/src/pin/remote").AddOptions & import("ipfs-core-types/src/utils").AbortOptions & import("../../types").HTTPClientExtraOptions): Promise<import("ipfs-core-types/src/pin/remote").Pin>;
