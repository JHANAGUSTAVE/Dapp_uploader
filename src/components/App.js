...
import File from '../contracts/SimpleStorage.json'
...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    if(networkData) {
      const app = new web3.eth.Contract(File.abi, networkData.address)
      this.setState({ app })
      ...
      window.alert('File contract not deployed to detected network.')
    }
  }
